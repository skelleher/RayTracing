...
int renderSceneVulkan( const Scene& scene, const Camera& camera, unsigned rows, unsigned cols, uint32_t* frameBuffer, unsigned num_aa_samples = 4, unsigned max_ray_depth = 50, unsigned blockSize = 64, bool debug = false );
